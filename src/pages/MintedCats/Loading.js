...
const Loading = ({ title }) => {
    return (<>
        <svg class="lds-bluecat mx-auto pt-16" width="400px" height="400px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
        ...
        <div className="mx-auto text-lg font-semibold text-center"> {title || "Loading your cats..."}</div>
    </>
    );
}
